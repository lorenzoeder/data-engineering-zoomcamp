...
# GCS_BUCKET_NAME: Set to override default bucket name (optional)
# 
...
BUCKET_NAME = os.getenv("GCS_BUCKET_NAME", "dezoomcamp_hw3_2026")

# Initialize storage client
# Credentials are automatically discovered from:
# - gcloud auth application-default login
# - GOOGLE_APPLICATION_CREDENTIALS environment variable
# - Service account on GCP resources
...
def create_bucket(bucket_name):
    try:
        ...
        bucket = client.create_bucket(bucket_name, location="europe-west2")
